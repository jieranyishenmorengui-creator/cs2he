...
// - Case CONFIG: column is hidden explicitly by the user (e.g. via the context menu, or _DefaultHide column flag, etc.).
//
//                        [A]         [B]          [CONFIG]
...
void ImGui::TableBeginApplyRequests(ImGuiTable* table)
{
    ...
    if (table->InstanceCurrent == 0)
    {
        ...
        if (table->ReorderColumn != -1 && table->ReorderColumnDir != 0)
        {
            ...
            // In the configuration below, moving CONFIG to the right of E will lead to:
            //    ... CONFIG [D] E  --->  ... [D] E  CONFIG   (Column name/index)
