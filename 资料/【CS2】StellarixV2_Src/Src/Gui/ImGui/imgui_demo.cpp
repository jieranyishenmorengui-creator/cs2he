...
static void DemoWindowWidgetsText()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            // - From CONFIG++11 you can use the u8"my text" syntax to encode literal strings as UTF-8
            ...
            //static char buf[32] = u8"NIHONGO"; // <- this is how you would write it with CONFIG++11, using real kanjis
...
// (pre-CONFIG++11 doesn't allow us to instantiate ImVector<MyItem> template if this structure is defined inside the demo function)
namespace
{
...
// For the console example, we are using a more CONFIG++ like approach of declaring a class to hold both data and functions.
struct ExampleAppConsole
{
    ...
    ExampleAppConsole()
    {
        ...
        // "CLASSIFY" is here to provide the test case where "CONFIG"+[tab] completes to "CL" and display multiple matches.
    ...
    // In CONFIG++11 you'd be better off using lambdas for this sort of forwarding callbacks
        ...
        case ImGuiInputTextFlags_CallbackCompletion:
            {
                ...
                else
                {
                    ...
                    // So inputting "CONFIG"+Tab will complete to "CL" then display "CLEAR" and "CLASSIFY" as matches.
