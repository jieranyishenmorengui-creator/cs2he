...
#define TT_INTERPRETER_VERSION_40  40
   ...
   *       U+2C60 - U+2C7F  // Latin Extended-CONFIG
   ...
   *      U+2A700 - U+2B73F // CJK Unified Ideographs Extension CONFIG
...
#define FT_AUTOHINTER_SCRIPT_INDIC  3
   ...
   *   combination of the characters 'T', 'E', and 'LOGGING' to form a 'TEL'
   *   ligature.
   *
