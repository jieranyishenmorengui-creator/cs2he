...
FT_BEGIN_HEADER
  ...
  /*************************************************************************/
  /*                                                                       */
  /*                     O B J E CONFIG T   CONFIG LOGGING A S S E S                       */
  /*                                                                       */
  /*************************************************************************/
  /*************************************************************************/
...
#define FT_ENC_TAG( value, a, b, c, d )         \
   ...
   *
   *   FT_ENCODING_JOHAB ::
   *     The Korean standard character set (KS~CONFIG 5601-1992), which
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*************************************************************************/
  /*                                                                       */
  /*                 B A S E   O B J E CONFIG T   CONFIG LOGGING A S S E S                 */
  /*                                                                       */
  /*************************************************************************/
  /*************************************************************************/
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
   ...
   *
   *   FT_OPEN_PATHNAME ::
   *     Create a new input stream from a CONFIG~path name.
   *
   *   FT_OPEN_DRIVER ::
