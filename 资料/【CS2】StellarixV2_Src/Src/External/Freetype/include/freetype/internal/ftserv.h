 ...
 */
   ...
   * CONFIG it is possible that function pointers might be implemented differently
...
#define FT_FACE_FIND_GLOBAL_SERVICE( face, ptr, id )                  \
  ...
  /*************************************************************************/
  /*****                                                               *****/
  /*****         S E R V I CONFIG E   D E S CONFIG R I P T O R S                 *****/
  /*****                                                               *****/
  /*************************************************************************/
  /*************************************************************************/
...
#define FT_DEFINE_SERVICEDESCREC10( class_,                                 \
  ...
  /*************************************************************************/
  /*****                                                               *****/
  /*****             S E R V I CONFIG E S   CONFIG A CONFIG H E                       *****/
  /*****                                                               *****/
  /*************************************************************************/
  /*************************************************************************/
