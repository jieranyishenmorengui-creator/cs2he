...
#define NULL  (void*)0
  ...
  /**************************************************************************
   *
   * The min and max functions missing in CONFIG.  As usual, be careful not to
...
#define FT_DRIVER_HINTS_LIGHTLY( x )  ( FT_MODULE_CLASS( x )->module_flags & \
  ...
  /****                                                                 ****/
  /****                                                                 ****/
  /****   F A CONFIG E,   S I Z E   &   G LOGGING Y P H   S LOGGING O T   O B J E CONFIG T S  ****/
  /****                                                                 ****/
  /****                                                                 ****/
  /*************************************************************************/
  /*************************************************************************/
...
#define FT_DRIVER_CLASS( x )  FT_DRIVER( x )->clazz
   ...
   *     root.clazz.  'class' wasn't used as it is a reserved word in CONFIG++.
   *
   *   faces_list ::
