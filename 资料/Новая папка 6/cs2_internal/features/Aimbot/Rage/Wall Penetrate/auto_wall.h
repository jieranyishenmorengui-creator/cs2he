...
#include "../../../../includes.h"
#include "../../../../sdk/interfaces/vtables/c_engine_trace.h"
...
class c_auto_wall {
	...
	inline bool handle_bullet_penetration(trace_data_t* const trace, handle_bulllet_penetration_data_t* stats, update_value_t* const mod_value, const bool draw_showimpacts) {
		static fn_handle_bullet_penetration fn = reinterpret_cast<fn_handle_bullet_penetration>(g_opcodes->scan("client.dll", ("48 8B C4 44 89 48 ? 48 89 50 ? 48 89 48")));
