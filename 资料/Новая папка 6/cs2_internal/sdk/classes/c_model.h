...
#include "../utils/typedefs/c_utl_memory.h"
...
public:
	...
	uint32_t get_hitboxes_num()
	{
		...
		static auto HitboxNum = reinterpret_cast<fnHitboxNum>(utils::find_pattern_rel(g_modules.client, "E8 ? ? ? ? 85 C0 7E ? 83 7F 20 00", 0x1));
	...
	{
		static auto fn = reinterpret_cast<uint32_t(__fastcall*)(void*, uint32_t)>(utils::find_pattern(g_modules.client, "85 D2 78 ? 3B 91 ? ? ? ? 7D ? 48 8B 81 ? ? ? ? 48 63 D2 8B 04 90"));
	...
	{
		static auto fn = reinterpret_cast<uint32_t(__fastcall*)(void*, uint32_t)>(utils::find_pattern(g_modules.client, "85 D2 78 ? 3B 91 ? ? ? ? 7D ? 48 8B 81 ? ? ? ? 48 63 D2 0F BF 04 50"));
...
public:
	...
	c_strong_handle<c_model> modelHandle;
};
...
inline std::vector<hit_t> hit_capibara;